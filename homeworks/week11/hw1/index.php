  ...
  <main class="board">
    ...
    <section>
      <?php
        ...
        "a_u_z_users as U on C.username = U.username where C.is_deleted is NULL order by C.id DESC";
        ...
        <div class="card__body">
          <div class="card__info">
            ...
            <?php if ($username == $row['username']) { ?>
              <a href="update_comment.php?id=<?php echo prevent_XSS($row['id'])?>">編輯</a>
              <a href="handle_delete_comment.php?id=<?php echo prevent_XSS($row['id'])?>">刪除</a>
            <?php } ?>
          </div>
